...
**Live:** [https://relaxed-weasel-openreplay.cloud.nexlayer.ai](https://relaxed-weasel-openreplay.cloud.nexlayer.ai)  
...
**openreplay** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: public.ecr.aws/p1t3u8a3/frontend:v1.27.14
    path: /
    servicePorts:
    - 8080
```
